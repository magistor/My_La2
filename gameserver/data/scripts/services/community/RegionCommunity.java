...
public class RegionCommunity implements ScriptFile, ICommunityBoardHandler {
    ...
    public void onBypassCommand(Player player, String bypass) {
        ...
        if ("bbsloc".equals(cmd)) {
            String tpl = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_regiontpl.htm", player);
            ...
            HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_region_list.htm", player));
            ...
            String tpl = HtmCache.getInstance().getHtml("scripts/services/community/bbs_regiontpl.htm", player);
            ...
            String html = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_region_sellers.htm", player);
            if (page == 1) {
            ...
            String tpl = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_region_stpl.htm", player);
            ...
            String title = "-";
            String tpl = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_region_storetpl.htm", player);
            ...
            String html = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_region_view.htm", player);
