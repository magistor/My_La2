...
import l2p.gameserver.serverpackets.ExMailArrived;
...
public class ClanCommunity extends Functions implements ScriptFile, ICommunityBoardHandler {
    ...
    public void onBypassCommand(Player player, String bypass) {
        ...
        if ("bbsclan".equals(cmd)) {
            ...
            HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_clanlist.htm", player));
            ...
            String tpl = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_clantpl.htm", player);
            ...
            HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_clan.htm", player));
            String html = tpls.get(0);
            ...
            String html = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_clanadmin.htm", player);
            ...
            String html = HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_pledge_mail_write.htm", player);
            ...
            HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getHtml(Config.BBS_HOME_DIR + "bbs_clanannounce.htm", player));
            String html = tpls.get(0);
    ...
    private class Listener implements OnPlayerEnterListener {
        ...
        public void onPlayerEnter(Player player) {
            ...
            if (!clan.getNotice().isEmpty()) {
                ...
                msg.setFile(Config.BBS_HOME_DIR + "clan_popup.htm");
