...
public class CommunityBoardItemInfo implements ScriptFile, ICommunityBoardHandler {
    ...
    private String generateItemSkills(Player player, int id) {
        ...
        for (Skill skill : temp.getAttachedSkills()) {
            ...
            result.append("<font color=\"0099FF\">").append(player.getLanguage() == Language.RUSSIAN ? "Название скила:" : "Item information").append("</font>" + skill.getName() + "<br1>").append(player.getLanguage() == Language.RUSSIAN ? "ID скила: " : "Skill id: ").append(skill.getId());
            result.append("</td>");
            result.append("</tr>");
        }
    ...
    private String generateItemInfo(Player player, int id) {
        ...
        if ((temp != null) && !temp.isArmor() && !temp.isWeapon() && !temp.isAccessory()) {
            ...
            result.append("</td>");
            result.append("<td FIXWIDTH=671 align=left valign=top>");
            result.append("<font color=\"0099FF\">").append(player.getLanguage() == Language.RUSSIAN ? "Название предмета:</font> " : "Item name:</font> ").append(HtmlUtils.htmlItemName(etcitem.getItemId())).append("<br1><font color=\"LEVEL\">").append(player.getLanguage() == Language.RUSSIAN ? "ID предмета:</font> " : "Item ID:</font> ").append(etcitem.getItemId()).append("&nbsp;");
            result.append("</td>");
            result.append("</tr>");
            result.append("</table>");
            result.append("<table border=0 cellspacing=0 cellpadding=0>");
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Будет стыковаться: " : "It will be docked: ").append(etcitem.isStackable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("</font><br>");
            result.append("</td>");
            result.append("<td>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Временный предмет: " : "A temporary items: ").append(etcitem.getDurability() > 0 ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("</font><br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно выбросить: " : "You can throw: ").append(etcitem.isDropable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("</font><br>");
            result.append("</td>");
            result.append("<td>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно продать: " : "Can be sold: ").append(etcitem.isSellable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("</font><br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно обменять: " : "Can be exchanged: ").append(etcitem.isStoreable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("</font><br>");
            result.append("</td>");
            result.append("</tr>");
            result.append("</table></center>");
    ...
    private String generateWeaponInfo(Player player, int id) {
        ...
        if ((temp != null) && temp.isWeapon()) {
            ...
            result.append("<tr>");
            result.append("<td>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Грейд оружия: " : "Weapon grade: ").append("</font>").append(weapon.getCrystalType()).append("&nbsp;").append("<br>");
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Разбивается на кристаллы: " : "Divided into crystals: ").append("</font>").append(weapon.isCrystallizable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Оружие камаелей: " : "Kamael weapons: ").append("</font>").append(weapon.getKamaelConvert() > 0 ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("</td>");
            result.append("<td>");
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Будет стыковаться: " : "It will be docked: ").append("</font>").append(weapon.isStackable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Временный предмет: " : "A temporary item: ").append("</font>").append(weapon.getDurability() > 0 ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно выбросить: " : "You can throw: ").append("</font>").append(weapon.isDropable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            ...
            result.append("</td>");
            result.append("<td>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно продать: " : "Can be sold: ").append("</font>").append(weapon.isSellable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно вставить аугментацию: " : "You can insert the argument: ").append("</font>").append(weapon.isAugmentable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно вставить атрибут: " : "You can insert an attribute: ").append("</font>").append(weapon.isAttributable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно обменять: " : "Can be exchanged: ").append("</font>").append(weapon.isStoreable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
    ...
    private String generateArmorInfo(Player player, int id) {
        ...
        if ((temp != null) && (temp.isArmor() || temp.isAccessory())) {
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Разбивается на кристаллы: " : "Divided into crystals: ").append("</font>").append(armor.isCrystallizable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            ...
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Будет стыковаться: " : "It will be docked: ").append("</font>").append(armor.isStackable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Временный предмет: " : "A temporary item: ").append("</font>").append(armor.getDurability() > 0 ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно выбросить: " : "You can throw: ").append("</font>").append(armor.isDropable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("</td>");
            result.append("<td>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно продать: " : "Can be sold: ").append("</font>").append(armor.isSellable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно вставить аугментацию: " : "You can insert the argument: ").append("</font>").append(armor.isAugmentable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно вставить атрибут: " : "You can insert an attribute: ").append("</font>").append(armor.isAttributable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("› <font color=\"b09979\">").append(player.getLanguage() == Language.RUSSIAN ? "Можно обменять: " : "Can be exchanged: ").append("</font>").append(armor.isStoreable() ? player.getLanguage() == Language.RUSSIAN ? "да" : "yes" : player.getLanguage() == Language.RUSSIAN ? "нет" : "no").append("&nbsp;").append("<br>");
            result.append("</td>");
            result.append("</tr>");
            result.append("</table></center>");
