...
/**
 * @author PaInKiLlEr and Felixx - AI для мобов Sel Mahum Squad Leader (22786,
 * 22787, 22788). - Когда на костре появляется Катёл (18933) то нпцы сбигаются,
 * садятся и ставят символ еды над головой. - Когда костер загорается (18927),
 * есть шанс 30% что они захотят спать и сбегуться к нему и появится символ сна
 * над головой. - Перед тем как броситься питаться, кричат в чат. - Когда имеют
 * над головой символы, статы значительно уменьшаются. - AI проверен и работает.
 */
