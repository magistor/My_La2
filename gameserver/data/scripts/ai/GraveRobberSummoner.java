...
/**
 * При спавне саммонят случайную охрану. Защита прямо пропорциональна количеству
 * охранников.
 */
public class GraveRobberSummoner extends Mystic {
    ...
    protected void onEvtSpawn() {
        ...
        actor.getMinionList().addMinion(new MinionData(Servitors[Rnd.get(Servitors.length)], 1, 2));
