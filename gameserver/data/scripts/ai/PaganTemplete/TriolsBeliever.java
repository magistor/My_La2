...
/**
 * - AI для монстра Triols Believer (22143) и Triols Priest (22146) и Triols
 * Priest (22151). - Если увидел игрока в радиусе 500, если его пати состовляет
 * больше 4 мемберов. - Тогда выбрасывает на рандомные координаты первого
 * увидевшего игрока. - AI проверен и работает.
 */
