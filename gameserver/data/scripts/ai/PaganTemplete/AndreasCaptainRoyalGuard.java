...
/**
 * - AI для монстра Andreas Captain Royal Guard (22175). - Если увидел игрока в
 * радиусе 500, если его пати состовляет больше 9 мемберов. - Тогда выбрасывает
 * на рандомные координаты первого увидевшего игрока. - При атаке когда остаётся
 * ХП меньше 70%, кидают дебаф и умерают. - AI проверен и работает.
 */
