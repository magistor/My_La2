...
/**
 * @author PaInKiLlEr - AI для Furnace (18914). - При спавне имеет собственный
 * ник. - При атаке загорается, сбрасывает у игрока таргет, включает
 * неактивность таргета. - Кричит в чат при ударе. - Через 15 секунд исчезают
 * все жаровни. - Запускается евент и комната респавнится с монстрами воинами. -
