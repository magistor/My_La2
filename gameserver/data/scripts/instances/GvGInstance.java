...
public class GvGInstance extends Reflection {
    ...
    /**
     * @return Whether event is active. active starts with instance dungeon and
     * ends with team victory
     */
    ...
    /**
     * Paralyzes everybody in instance to prevent any actions while event is
     * !isActive
     */
    ...
    /**
     * @param player
     * @param refId Called by onDeath. Handles the resurrection at the proper
     * base.
     */
     ...
     * Removes player from every list or instance, teleports him and stops the
     * event timer
     */
    ...
    /**
     * @param isRed Handles the team withdraw from the area of event. Can only
     * be called when !isActive
     */
