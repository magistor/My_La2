 ...
 *
 * 001 - first 002 - success independent 003 - not leader 004 - success contract
 * 005 - fail contract
 */
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        switch (cond) {
            case COND_LEADER:
                ...
                } else //else if(command.equalsIgnoreCase("no"))
                {
                    castleId = 0;
                ...
                player.sendPacket(new HtmlMessage(player, this, fileName, 0));
                break;
            case COND_FAIL:
                player.sendPacket(new HtmlMessage(player, this, _failDialog, 0));
                break;
        }
    }
