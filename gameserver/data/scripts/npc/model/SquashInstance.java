...
public class SquashInstance extends SpecialMonsterInstance {
    ...
    public void reduceCurrentHp(double i, Creature attacker, Skill skill, boolean awake, boolean standUp, boolean directHp, boolean canReflect, boolean transferDamage, boolean isDot, boolean sendMessage) {
        ...
        if (getNpcId() == High_Quality_Squash || getNpcId() == Low_Quality_Squash || getNpcId() == Large_Young_Squash || getNpcId() == Young_Squash || getNpcId() == King_Squash || getNpcId() == Low_Quality_Large_Squash || getNpcId() == High_Quality_Large_Squash || getNpcId() == Emperor_Squash) // Разрешенное оружие для больших тыкв:
        // 4202 Chrono Cithara
        // 5133 Chrono Unitus
        // 5817 Chrono Campana
        // 7058 Chrono Darbuka
