...
public class TVTArena2 extends Functions
    ...
    private void spawnEventManagers() {
        int[][] EVENT_MANAGERS = {{82376, 148808, -3492, 0}};
    ...
    public String DialogAppend_36613(Integer val) {
        ...
        if (val.intValue() == 0) {
            return HtmCache.getInstance().getHtml("scripts/events/TVTArena/36613.htm", player);
        }
        return "";
    }
