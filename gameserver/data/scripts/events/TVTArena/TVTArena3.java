...
public class TVTArena3 extends Functions
    ...
    private void spawnEventManagers() {
        int[][] EVENT_MANAGERS = {{82376, 148600, -3492, 0}};
    ...
    public String DialogAppend_36614(Integer val) {
        ...
        if (val.intValue() == 0) {
            return HtmCache.getInstance().getHtml("scripts/events/TVTArena/36614.htm", player);
        }
        return "";
    }
