...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Gludio городе - ВНИМАНИЕ:
...
public class GludioCataclizm extends Cataclizm {
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            // if(_cycle)
            // player.sendPacket(new ExShowScreenMessage("Город Глудио захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!", 5000, ScreenMessageAlign.TOP_CENTER, false));
        }
