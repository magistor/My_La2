...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Dion городе - ВНИМАНИЕ: ни
...
public class DionCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[dion_town_peace1]");
    private static Zone _zone2 = ReflectionUtils.getZone("[dion_town_peace2]");
    private static Zone _zone3 = ReflectionUtils.getZone("[dion_town_peace3]");
    private static Zone _zone4 = ReflectionUtils.getZone("[dion_town_peace4]");
    private static Zone _zone5 = ReflectionUtils.getZone("[dion_town_peace5]");
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Дион захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
            }
        }
