...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Aden городе - ВНИМАНИЕ: ни
...
public class AdenCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[aden_town_peace1]");
    private static Zone _zone2 = ReflectionUtils.getZone("[aden_town_peace2]");
    private static Zone _zone3 = ReflectionUtils.getZone("[aden_town_peace3]");
    private static Zone _zone4 = ReflectionUtils.getZone("[aden_town_peace4]");
    private static Zone _zone5 = ReflectionUtils.getZone("[aden_town_peace5]");
    ...
    public String[] guards4 = new String[]{"18342,1;18342,1"}; // 4 ворота
    // 5 список пропускаем!!!
    ...
    public String[] guards11 = new String[]{"18342,1;18342,1"}; // Возле 5 КХ
    public String[] guards12 = new String[]{"18342,1;18342,1"}; // Возле 6 КХ
    // 13 список пропускаем!!!
    public static String[] guards14 = new String[]{"18342,1;18342,1"}; // Первая стенка мобов к статуе
    public static String[] guards15 = new String[]{"18342,1;18342,1"}; // Вторая стенка мобов к статуе
    public static String[] guards16 = new String[]{"18342,1;18342,1"}; // Вторая стенка мобов к статуе
    public static String[] guards17 = new String[]{"18342,1;18342,1"}; // Вторая стенка мобов к статуе
    public static String[] guards18 = new String[]{"18342,1;18342,1"}; // Вторая стенка мобов к статуе
    public static String[] guards19 = new String[]{"18342,1;18342,1"}; // Третья стенка мобов к статуе
    public static String[] guards20 = new String[]{"18342,1;18342,1"}; // Третья стенка мобов к статуе
    public static String[] guards21 = new String[]{"18342,1;18342,1"}; // Третья стенка мобов к статуе
    public static String[] guards22 = new String[]{"18342,1;18342,1"}; // Третья стенка мобов к статуе
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Аден захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
