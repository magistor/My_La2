...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Giran городе - ВНИМАНИЕ:
...
public class GiranCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[giran_town_peace1]");
    private static Zone _zone2 = ReflectionUtils.getZone("[giran_town_peace2]");
    private static Zone _zone3 = ReflectionUtils.getZone("[giran_town_peace3]");
    private static Zone _zone4 = ReflectionUtils.getZone("[giran_town_peace4]");
    private static Zone _zone5 = ReflectionUtils.getZone("[giran_town_peace5]");
    private static Zone _zone6 = ReflectionUtils.getZone("[giran_town_peace6]");
    private static Zone _zone7 = ReflectionUtils.getZone("[giran_town_peace7]");
    private static Zone _zone8 = ReflectionUtils.getZone("[giran_town_peace8]");
    private static Zone _zone9 = ReflectionUtils.getZone("[giran_town_peace9]");
    private static Zone _zone10 = ReflectionUtils.getZone("[giran_town_peace10]");
    private static Zone _zone11 = ReflectionUtils.getZone("[giran_town_peace11]");
    private static Zone _zone12 = ReflectionUtils.getZone("[giran_town_peace12]");
    ...
    public String[] guards4 = new String[]{"18342,1;18342,1"}; // Четвертые ворота
    public String[] guards5 = new String[]{"18342,1;18342,1"}; // Пятые ворота
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Гиран захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
