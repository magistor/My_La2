...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Rune городе - ВНИМАНИЕ: ни
...
public class RuneCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[rune_peace1]");
    private static Zone _zone2 = ReflectionUtils.getZone("[rune_peace2]");
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Руна захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
