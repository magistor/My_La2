...
public class HeineCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[heiness_peace1]");
    private static Zone _zone2 = ReflectionUtils.getZone("[heiness_peace2]");
    private static Zone _zone3 = ReflectionUtils.getZone("[heiness_peace3]");
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Хеина захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
