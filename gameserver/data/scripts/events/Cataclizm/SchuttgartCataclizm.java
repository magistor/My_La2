...
/**
 * @author PaInKiLlEr - Настройка евента катаклизма в Schuttgart городе -
 * ВНИМАНИЕ: ни в коем случае не должно произойти так что бы ID гвардов и статуй
 * совпадали с ID других городов - ВНИМАНИЕ: не ставить ID статуй/гвардов
 * которые участвуют стандартно в спавне (гремленов сменить тоже)
 */
public class SchuttgartCataclizm extends Cataclizm {
    ...
    private static Zone _zone1 = ReflectionUtils.getZone("[schuttgart_town_peace]");
    ...
    public void onLoad() {
        ...
        _log.info("Loaded Event: Cataclizm Schuttgard");
    }
    ...
    private static class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneEnter(Zone zone, Creature cha) {
            ...
            if (_cycle) {
                String msg = "Город Шутгард захвачен монстрами, пожалуйста покиньте город для вашей же безопасности!";
