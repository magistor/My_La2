...
/**
 * Created with IntelliJ IDEA. User: Darvin Date: 24.11.12 Time: 13:41
 */
public class Hitman extends Functions implements ScriptFile, OnDeathListener, OnPlayerExitListener {
    ...
    public void onPlayerExit(Player player) {
        ...
        if (_orderMap.containsKey(player.getOrdered())) {
            ...
            gamer.sendMessage("Event Hitman :" + (gamer.isLangRus() ? " Награда за убийство возвращена" : " Reward for murder returned"));
