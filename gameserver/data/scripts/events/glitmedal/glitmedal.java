...
/**
 * User: darkevil Date: 26.02.2008 Time: 1:17:42
 */
public class glitmedal extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener {
    ...
    private static File[] multiSellFiles = {
        new File(Config.DATAPACK_ROOT, "data/xml/scripts/glitmedal/502.xml"),
        new File(Config.DATAPACK_ROOT, "data/xml/scripts/glitmedal/503.xml"),
        new File(Config.DATAPACK_ROOT, "data/xml/scripts/glitmedal/504.xml"),
        new File(Config.DATAPACK_ROOT, "data/xml/scripts/glitmedal/505.xml"),
        new File(Config.DATAPACK_ROOT, "data/xml/scripts/glitmedal/506.xml"),};
