...
/**
 * User: Keiichi Date: 05.10.2008 Time: 19:45:18 Info: Один из 2х квестов для
 * прохода на остров Hellbound. Info: Пройдя его ведьма Galate открывает ТП до
 * локации (xyz = -11095, 236440, -3232)
 */
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("galate_q0130_07.htm") && cond == 3) {
            ...
            if (HellboundManager.getHellboundLevel() == 0) {
                HellboundManager.addConfidence(1);
            }
        }
