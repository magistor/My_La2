...
public class _188_SealRemoval extends Quest implements ScriptFile {
    ...
    private static final int LorainCertificate = 10362;
    ...
    public String onFirstTalk(NpcInstance npc, Player player) {
        ...
        if ((qs1 != null && qs1.isCompleted() || qs2 != null && qs2.isCompleted()) && player.getQuestState(getClass()) == null && player.getInventory().getItemByItemId(LorainCertificate) == null) {
