...
public class _192_SevenSignSeriesOfDoubt extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30676-03.htm")) {
            ...
            player.showQuestMovie(SceneMovie.SSQ_SERIES_OF_DOUBT);
            ...
            ThreadPoolManager.getInstance().schedule(new TaskVoid("teleBack", player), 26000);
            return "";
    ...
    class TaskVoid implements Runnable {
        ...
        public void run() {
            if (_name.equals("teleBack")) {
                teleBack(_player);
            }
        }
    }

    private void teleBack(Player player) {
        if (player != null) {
