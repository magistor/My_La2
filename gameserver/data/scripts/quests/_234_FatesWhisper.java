...
public class _234_FatesWhisper extends Quest implements ScriptFile {
    ...
    private final static int PlatinumSoldier = 20823;
    private final static int PlatinumWarrior = 20827;
    private final static int PlatinumArcher = 20826;
    private final static int PlatinumShaman = 20828;
    private final static int PlatinumOverlord = 20829;
    /**
     * Save the Soul of Reiria The soul of Reiria, Maestro Reorin's dearly
     * departed wife, is being held hostage by demons. He asks that you free her
     * by slaying Messenger Cabrio and recovering the soul orb. He was last seen
     * lurking in the northern part of the cemetery.
     */
    private final static int COND1 = 1;
    /**
     * Infernium Scepter In order to restore his honor, Maestro Reorin wishes to
     * recover his masterpiece from the demons. He asks that you recover his
     * three infernium scepters from Death Lord Hallate, his aide Kernon and
     * Longhorn Golkonda, who can be found in the Tower of Insolence.
     */
    private final static int COND2 = 2;
    /**
     * Infernium Varnish Maestro Reorin asks that you go to Warehouse Freightman
     * Cliff in the Town of Oren and obtain infernium varnish so he may continue
     * his enhancement of the infernium scepters.
     */
    private final static int COND3 = 3;
    /**
     * Specially Made Hammer Maestro Reorin asks that you recover his hammer
     * from Head Blacksmith Ferris in the Town of Aden, who confiscated it after
     * expelling the maestro from the guild.
     */
    private final static int COND4 = 4;
    /**
     * Maestro-Level Mold Go to Trader Zenkin in the Town of Oren and recover
     * the maestro-level mold that he bought from Reorin.
     */
    private final static int COND5 = 5;
    /**
     * To Hardin's Academy Trader Zenkin informs you that Maestro Reorin's mold
     * has already been sold to Magister Kaspar of Hardin's Academy. Try to
     * obtain the mold from him.
     */
    private final static int COND6 = 6;
    /**
     * Baium's Blood Magister Kaspar offers to give you Reorin's mold in
     * exchange for a sample of the blood of Baium. Baium is the emperor of the
     * ancient empire who is sealed in a room atop the Tower of Insolence. He is
     * said to have turned into a beast-like creature. Magister Hanellin of the
     * Town of Aden will tell you how to enter his room. When you attack him,
     * you must use a pipette knife and stab him with it.
     */
    private final static int COND7 = 7;
    /**
     * Blood of Angel Magister Caspa gave 30 pieces of white cloth to have them
     * stain with the blood of Platinum Faction and angels in the Tower of
     * Insolence. Let's bring them to Caspa by staining them with the blood of
     * angels.
     */
    private final static int COND8 = 8;
    /**
     * To Caspa All 30 pieces of white cloth have been stained with the blood of
     * angel as Caspa requested. Let's go back to Caspa.
     */
    private final static int COND9 = 9;
    /**
     * Holding a mold in a hand The Maestro Reorin's mold has been acquired!
     * Please go back to Reorin now.
     */
    private final static int COND10 = 10;
    /**
     * B Grade Crystal Many B-grade Crystals are required in order to process
     * molten infernium. Obtain 984 crystals and deliver them to Maestro Reorin.
     */
    private final static int COND11 = 11;
    /**
     * Equipment Fusion In order to neutralize a hazardous energy emited from
     * raw Infernium, you will need to mix it with a B-Grade item in to create a
     * new alloy. Bring a B-grade weapon to Maestro Reorin.
     */
    ...
    public _234_FatesWhisper() {
        ...
        addKillId(PlatinumSoldier, PlatinumWarrior, PlatinumArcher, PlatinumShaman, PlatinumOverlord);
        addAttackId(BAIUM);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == COND8 && (npcId == PlatinumSoldier || npcId == PlatinumWarrior || npcId == PlatinumArcher || npcId == PlatinumShaman || npcId == PlatinumOverlord)) {
            long count = st.getQuestItemsCount(BloodStainedCloth);
            if (st.getQuestItemsCount(WhiteCloth) > 0 && count < 30 && Rnd.chance(15)) {
                st.giveItems(BloodStainedCloth, 1);
                if (count >= 29) {
                    st.takeItems(WhiteCloth, -1);
                    st.setCond(COND9);
