...
public class _642_APowerfulPrimevalCreature extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (_state == STARTED) {
            ...
            if (Dinosaur_Tissue_Count >= 450 && st.getQuestItemsCount(Dinosaur_Egg) == 0) {
                return "dindin_q0642_07b.htm";
            }
            if (Dinosaur_Tissue_Count >= 150 && Dinosaur_Tissue_Count < 450 && st.getQuestItemsCount(Dinosaur_Egg) != 0) {
                return "dindin_q0642_07a.htm";
            }
            if (Dinosaur_Tissue_Count >= 450 && st.getQuestItemsCount(Dinosaur_Egg) != 0) {
                return "dindin_q0642_07c.htm";
            }
