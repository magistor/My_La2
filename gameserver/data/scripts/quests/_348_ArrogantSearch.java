...
public class _348_ArrogantSearch extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        int cond = st.getCond();
        if (npcId == HANELLIN) {
            if (id == CREATED) // if the quest was completed and the player still has a blooded fabric
            ...
            } else if (npcId == ARK_GUARDIANS_CORPSE) // if you do not have the key (first meeting)
            {
